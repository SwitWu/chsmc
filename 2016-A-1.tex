  ...
  \item （本题满分 20 分）
    ...
    \begin{solution}
      ...
      \[
        ...
        = \frac{1}{k}\,f\!\left(\frac{1}{k}\right),
      \]
      即 $\dfrac{a_{k+1}}{a_k} = \dfrac{1}{k}$.\hfill（5 分）
      ...
      \begin{align*}
        ...
        &= \sum_{i=1}^{50} \frac{1}{(i-1)!\,(100-i)!}
         = \sum_{i=0}^{49} \frac{1}{i!\,(99-i)!} \\
        &= \frac{1}{99!} \sum_{i=0}^{49} C_{99}^i
         = \frac{1}{99!} \sum_{i=0}^{49} \frac{1}{2}\bigl(C_{99}^i + C_{99}^{99-i}\bigr)
         = \frac{1}{99!} \times \frac{1}{2} \times 2^{99}
         = \frac{2^{98}}{99!}.
      \end{align*}
      \hfill（20 分）
    \end{solution}
